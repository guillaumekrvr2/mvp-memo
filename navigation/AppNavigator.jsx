...
const hideOn = ['Memorisation', 'Decompte', 'Recall', 'Cards', 'CardsGame', 'CardsRecall', 'Words']
    ...
    >
      <Tab.Screen
        ...
        options={({ route }) => {
          ...
          const hideTabsOn = ['Memorisation', 'Decompte', 'Recall', 'Numbers', 'Cards', 'CardsGame', 'CardsRecall', 'BinaryMemo', 'BinaryRecall', 'Binaries', 'Words']
